...
public class InputPage {
    ...
    //Xpath in Appium analyzes the XML structure of the app and then locates the element.
    // Xpath should only be used when there is no ID, Name, or accessibility ID assigned
    // to a specific UI element. Although XPath allows for the formulation of complex queries,
